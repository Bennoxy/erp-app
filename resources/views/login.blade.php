              ...
              <div class="row g-0">
                ...
                <div class="col-lg-6">
                  <div class="card-body p-4 p-sm-5">
                    <h5 class="card-title mb-5">ERP Login</h5>
                    <!-- <p class="card-text mb-5">See your growth and get consulting support!</p> -->
                    @if (Session::has('msg'))
                      <p class="text-danger">{{sesion('msg')}}</p>
                    @endif
                    @if ($errors->any())
                      ...
                      @endforeach
                    @endif
                    <form class="form-body" method="post" action="{{url('admin')}}">
                      @csrf
                      <!-- <div class="d-grid">
                        ...
                        <div class="row g-3">
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="text" class="form-control radius-30 ps-5" id="employeeId" placeholder="Employee ID Number">
                            </div>
                          </div>
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="password" class="form-control radius-30 ps-5" id="password" placeholder="Enter Password">
                            </div>
                          </div>
                          <!-- <div class="col-6">
