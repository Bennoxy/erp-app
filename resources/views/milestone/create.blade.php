        ...
        <!--breadcrumb-->
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    ...
                    <a href="{{ route('milestone.show',$d->id) }}" role="button" class="btn btn-primary"><i class="bi bi-view-list"></i>  View Milestone</a>
                </div>
            </div>
        <!--end breadcrumb-->
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="mb-0 text-uppercase">Add Milestone</h6>
                            <hr/>
                                <form class="form-body row g-3" action="{{ route('milestone.store') }}" method="POST" >
                                    @csrf  
