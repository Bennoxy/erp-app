                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="text" class="form-control radius-30 ps-5" name="name" id="name" placeholder="Vehicle Code" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"></div>
                                                <input type="text" class="form-control radius-30 ps-5" name="date" id="date" placeholder="Destination" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"></div>
                                                <input type="date" class="form-control radius-30 ps-5" name="date" id="date" placeholder="Date" required>
                                            </div>
                                        </div>                                        
                                        <div class="col-md-6">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"></div>
                                                <input type="text" class="form-control radius-30 ps-5" name="time_out" id="time_out" placeholder="Time Out" required>
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-6">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"></div>
                                                <input type="text" class="form-control radius-30 ps-5" name="time_in" id="time_in" placeholder="Time In" required>
                                            </div>
                                        </div> --}}
                                        <div >
                                            <button type="submit" class="btn btn-primary radius-30">Add Vehicle Log</button>
                                        </div>
