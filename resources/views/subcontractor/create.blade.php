                ...
                <div class="row">
					<div class="col-xl-6 mx-auto">
                        <div class="card">
                            ...
                            <h6 class="mb-0 text-uppercase">Add Subcontractor</h6>
                            <hr/>
                                <form class="form-body" action="{{ route('subcontractor.store') }}" method="POST" >
                                    @csrf   
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="text" class="form-control radius-30 ps-5" name="subcontractor" id="subcontractor"  required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"></div>
                                                <input type="text" class="form-control radius-30 ps-5" name="contact_name" id="contact_name" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"></div>
                                                <input type="text" class="form-control radius-30 ps-5" name="trade" id="trade"  required>
                                            </div>
                                        </div>
                                        <div >
                                            <button type="submit" class="btn btn-primary radius-30">Add Subcontractor</button>
                                        </div>
