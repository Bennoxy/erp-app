        ...
        <!--breadcrumb-->
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    ...
                    <a href="{{ route('task.index') }}" role="button" class="btn btn-primary"><i class="bi bi-view-list"></i>  View Tasks</a>
                </div>
            </div>
        <!--end breadcrumb-->
                                ...
                                <form class="form-body row g-3" action="{{ route('task.store') }}" method="POST" >
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="status" name="status" class="form-select " required>
                                            ...
                                            <option value="NewTask">NewProject</option>                                            
                                    ...
                                    <div class="">
                                        <button type="submit" class="btn btn-primary radius-30">Add Task</button>
                                    </div>
                                </form>
                        </div>
                    </div>
