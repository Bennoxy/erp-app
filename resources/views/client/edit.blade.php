                ...
                <div class="row">
					<div class="col-xl-6 mx-auto">
                        <div class="card">
                            ...
                            <hr/>
                                <form class="form-body" action="{{ route('client.update', $d->id) }}" method="POST" >
                                    @csrf
                                    @method('PUT')   
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="text" class="form-control radius-30 ps-5" name="name" value="{{ $d->name }}" id="name" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"></div>
                                                <input type="text" class="form-control radius-30 ps-5" name="address" value="{{ $d->address }}" id="address" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div >
                                            <button type="submit" class="btn btn-primary radius-30">Update Client</button>
                                        </div>
